$(document).ready(function(){
  ...
  //----------------------------//
  //----- API Musix Match -----//
  // var urlBase = "https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.lyrics.get?apikey=" + "1a27e75bdb2640b7855e3bb00431c1d9" + "&track_id=";

  var urlBase = "https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.lyrics.get?apikey=" + process.env.apiKey_lyrics + "&track_id=";
